...
- For structure questions, read `./references/event-repo-structure.md`.
- For challenge folder contents and packaging, read `./references/challenge-directory-contract.md`.
